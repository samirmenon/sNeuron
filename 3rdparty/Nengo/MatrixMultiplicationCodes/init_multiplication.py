...
def init_multiplication(n,populationSize,tau):
  ...
  for i in range(0,n):
    for j in range(0,n):
      ...
      bO[i][j] = b[i][j].addDecodedOrigin \
        ("b"+str(i+1)+str(j+1), [IdentityFunction], \
        Neuron.AXON);
  ...
  network_outer.addProjection(input5.getOrigin('origin'), network.getTermination("b31"))

  network_outer.addProjection(input4.getOrigin('origin'), network.getTermination("a23"))
  network_outer.addProjection(input4.getOrigin('origin'), network.getTermination("b11"))
  network_outer.addProjection(input4.getOrigin('origin'), network.getTermination("b22"))
  ...
  network_outer.addProjection(input0.getOrigin('origin'), network.getTermination("b13"))
  network_outer.addProjection(input0.getOrigin('origin'), network.getTermination("b33"))
  network_outer.addProjection(input0.getOrigin('origin'), network.getTermination("b32"))
  network_outer.addProjection(input0.getOrigin('origin'), network.getTermination("b21"))
  ...
  network_outer.addProjection(input1.getOrigin('origin'), network.getTermination("b12"))
  network_outer.addProjection(input1.getOrigin('origin'), network.getTermination("b23"))
  ...
  for i in range(0,n):
    for j in range(0,n):
      ...
      network.simulator.addProbe("r"+str(i+1)+str(j+1), r[i][j],"r"+str(i+1)+str(j+1),True)
      network.exposeState(r[i][j],"r"+str(i+1)+str(j+1), "r"+str(i+1)+str(j+1))
