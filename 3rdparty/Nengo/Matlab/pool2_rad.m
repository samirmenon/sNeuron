%%
function [ mean_time std_time mean_val std_val ] = pool2_rad( val )
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
str = strcat('C:\Users\Srish\Desktop\NewestSimulations\2pool_Radius\Value',num2str(val),'\');
...
subplot(2,1,2);
 ...
 legend('rad=1','rad=2','rad=10','rad=17');
ss1 = strcat('Plots_Newest/Radius_Value_',num2str(val),'.tif');
ss2 = strcat('Plots_Newest/Radius_Value_',num2str(val),'.eps');
saveas(h,ss1);
saveas(h,ss2);
close;
end
